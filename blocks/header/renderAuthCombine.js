/**
 * DEPRECATED: Authentication Combine Renderer (Mobile Auth Modal)
 *
...
import { PostLogoutHandler } from '../../utils/cart-checkout.js';

// Log deprecation warning when this module is imported
console.warn(
  'renderAuthCombine.js is deprecated. '
  + 'Authentication is now handled by the nav block with login-nav widget. '
  + 'See blocks/nav/nav-mobile-header.js for current mobile auth implementation.',
);
